                    ...
                    <table width="100%" style="text-align:center; barckgorund-color:#fff;">
                      <tr>
                        <td width="33%">
                          ...
                          ?>
                          <a <?php echo "href='listar_usuarios.php?pagina=$paginaciona'"; ?>><?php echo $paginacion-1;?></a>
                          <?php
                            }else{
                              echo " ";
                            }
                          ?>
                          <a href="listar_usuarios.php"><?php echo $paginacion;?></a>
                          <?php 
                            if($paginacion+1<=$paginas){
                              $paginacionn=$paginacion+1;
                          ?>
                          <a <?php echo "href='listar_usuarios.php?pagina=$paginacionn'"; ?>><?php echo $paginacion+1;?></a>
                          <?php
                            }
                          ?>
                        </td>
